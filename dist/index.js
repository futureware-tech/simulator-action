...
const xcrun_1 = __webpack_require__(8222);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const matchingDevices = (yield xcrun_1.getDevices()).filter(device => {
                ...
                if (os_version && !semver_1.satisfies(device.os_version, os_version)) {
                    return false;
                }
                return true;
            });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.simctl = exports.getDevices = void 0;
const core = __importStar(__webpack_require__(2186));
...
function getDevices() {
    return __awaiter(this, void 0, void 0, function* () {
        const { stdout, stderr } = yield execAsync('xcrun simctl list --json devices available');
        if (stderr) {
        ...
        const runtimes = JSON.parse(stdout).devices;
        ...
        for (const [runtime, devices] of Object.entries(runtimes)) {
            if (runtime.startsWith(runtimePrefix)) {
                ...
                for (const device of devices) {
                    allDevices.push(Object.assign(Object.assign({}, device), { model: device.name, os,
                        os_version }));
                }
            }
        }
...
function simctl(action, udid) {
    return __awaiter(this, void 0, void 0, function* () {
        const { stdout, stderr } = yield execAsync(`xcrun simctl ${action} ${udid}`);
        if (stderr) {
