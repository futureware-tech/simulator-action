...
const boolean_1 = __nccwpck_require__(1253);
const semver = __importStar(__nccwpck_require__(1383));
const xcrun_1 = __nccwpck_require__(8222);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const matchingDevices = (yield xcrun_1.getDevices()).filter(device => {
                core.debug(`- ${xcrun_1.deviceToString(device)}`);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (udid) {
                ...
                yield xcrun_1.simctl('shutdown', udid);
            }
        }
        catch (error) {
            core.setFailed(error.message);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.simctl = exports.getDevices = exports.deviceToString = void 0;
const core = __importStar(__nccwpck_require__(2186));
...
const boolean_1 = __nccwpck_require__(8641);
Object.defineProperty(exports, "boolean", ({ enumerable: true, get: function () { return boolean_1.boolean; } }));
const isBooleanable_1 = __nccwpck_require__(4030);
